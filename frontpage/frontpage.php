<?php
if ((isset($_POST['pontuacao']))&&(!empty($_POST['pontuacao']))) {

$conexao = mysqli_connect("localhost", "Walker", "Venula111", "login");

$pontuacao = $_POST['pontuacao'];

$string_sql = "INSERT INTO user(score) VALUES ('${pontuacao}')";
    ...
    <center>
        <div id="modal">
          <center>
            ...
            <h2 id="pontos">0</h2>
            <input type="submit"  id="pontos" name="pontuacao" value="Salvar Pontuacao">
            <button type="button" onclick="$('#modal').hide()">Reiniciar</button>
